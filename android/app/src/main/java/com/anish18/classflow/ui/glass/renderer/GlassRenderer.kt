package com.anish18.classflow.ui.glass.renderer
...
import com.anish18.classflow.ui.glass.utils.ShaderUtils
...
/**
 * OpenGL ES 2.0 renderer that produces the liquid glass effect for [com.anish18.classflow.ui.glass.GlassFrameLayout].
 *
 * ## Shader programs
 ...
 * - **blurH / blurV** (`glass_blur_h` / `glass_blur_v`): separable Gaussian blur run into two
 ...
 */
internal class GlassRenderer(private val context: Context) : GLSurfaceView.Renderer {
    companion object {
    ...
    private var shadowColor = floatArrayOf(0f, 0f, 0f, 0f)
    ...
    override fun onSurfaceCreated(glUnused: GL10?, config: EGLConfig?) {
        ...
        val blurHFragCode = ShaderUtils.loadShaderSource(context, R.raw.glass_blur_h)
        val blurVFragCode = ShaderUtils.loadShaderSource(context, R.raw.glass_blur_v)
    ...
    /**
     * Applies all parameters from a [GlassFilter] preset in one call.
     * Equivalent to calling each individual setter manually.
     */
    fun setFilter(filter: GlassFilter) {
