...
/**
 * Liquid Glass material for [GlassFrameLayout]
 *
...
object GlassLiquidGlass {
    ...
    private val SHADOW_COLOR = "#00000000".toColorInt()
    private const val GLASS_COLOR = 0x00000000  // fully transparent — tint comes from the shader, not an additive color overlay
     ...
     */
    @JvmStatic
    fun applyBase(layout: GlassFrameLayout) {
